...
import { User , CircleUserRound, MailIcon, LockIcon} from 'lucide-react';
        ...
        <div className='max-w-6xl w-full bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl min-h-[90vh] md:min-h-[70vh] lg:min-h-[90vh] flex'>
            ...
            <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-4'>
                ...
                <form className='w-full'>
                  ...
                  <div className='relative mb-3'>
                    ...
                    <input type='text' className='input' id='fullName' placeholder='John Doe'/>
                  </div>
                  {/* username */}
                ...
                {/* todo:Google or github signup with oAuth system */}
            </div>
            {/* right Section */}
            <div className='hidden md:block md:w-1/2  relative bg-gradient-to-br from-lime-400 to-lime-600 rounded-r-2xl p-4'>
              ...
              <div className='h-full w-full flex flex-col justify-center items-center'>
                ...
                <h4 className='text-lime-100 text-center font-medium text-lg'>Turn ideas into project with developers who care about building</h4>
              </div>
            </div>
        </div>
    </div>
